  ...
  return (
    <>
      <div className="foodShift-hero">
        <img className="foodshift-img" alt="foodShift logo" src={foodShiftLogo} />
        <img className="foodshift-img" alt="canKitchen logo" src={canKitchenLogoActive} />
      </div>
      ...
      <div className="content-container">
        ...
        <div className="foodshift-buttons-container">
          <a
